      ...
      <div className="flex">
                ...
                <div>
                    <div className="">
                        ...
                        <div className="max-w-[500px] overflow-hidden text-sm sm:text-base md:text-lg lg:text-[1.1rem] text-[#646464] font-thin">
                ...
                <div className="overflow-hidden w-[25.3rem] max-h-[38rem] group border rounded-2xl relative ml-7">
