      ...
      <div className="flex">
                ...
                <div>
                    <div className="">
                        ...
                        <div className='max-md:hidden'>
                            <div className="text-lg sm:text-xl md:text-2xl lg:text-3xl mt-3 mb-3 font-semibold  text-[#343736] max-md:mb-0">Grow Beyond, </div>
                            <div className="text-lg sm:text-xl md:text-3xl lg:text-3xl mt-3 mb-3 font-semibold  text-[#036B46] italic max-md:mt-0">Cultivate Tomorrow.</div>
                        </div>
                        <div className='md:hidden'>
                            <div className="text-lg sm:text-xl md:text-2xl lg:text-3xl mt-3 mb-3 font-semibold  text-[#343736] max-md:mb-0">Grow Beyond, <span className="text-[#036B46] italic">Cultivate</span></div>
                            <div className="text-lg sm:text-xl md:text-3xl lg:text-3xl mt-3 mb-3 font-semibold  text-[#036B46] italic max-md:mt-0"> Tomorrow.</div>
                        </div>
                    ...
                    <div className="overflow-hidden w-[25.3rem] max-h-[20rem] group border rounded-2xl relative mt-[3.9rem] mr-0 max-md:hidden">
                        ...
                        <Link aria-label="See agrity herbicides products" href="/products?=herbicides" className='bg-[#FFF] rounded-full px-5 py-2 text-[#005B1B] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] bg-opacity-[90%] flex justify-center items-center opacity-0 group-hover:opacity-100 transition-all duration-500 ease-in-out'>
                ...
                <div className='ml-[0.25rem] mt-[-0.2rem] max-md:hidden'>
                    <div className="overflow-hidden max-w-[25.3rem] max-h-[20rem] group border rounded-2xl relative">
                        ...
                        <Link aria-label="See agrity insecticides products" href="/products?=insecticides" className='bg-[#FFF] rounded-full px-5 py-2 text-[#005B1B] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] bg-opacity-[90%] flex justify-center items-center opacity-0 group-hover:opacity-100 transition-all duration-500 ease-in-out'>
                            <span className="mr-2">Explore</span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 scale-90">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                            </svg>
                    ...
                    <div className="overflow-hidden w-[25.3rem] max-h-[20rem] group border rounded-2xl relative mt-6">
                        ...
                        <Link aria-label="See agrity fungicides products"  href="/products?=fungicides" className='bg-[#FFF] rounded-full px-5 py-2 text-[#005B1B] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] bg-opacity-[90%] flex justify-center items-center opacity-0 group-hover:opacity-100 transition-all duration-500 ease-in-out'>
                            <span className="mr-2">Explore</span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 scale-90">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                            </svg>
                ...
                <div className="overflow-hidden w-[25.3rem] max-h-[38rem] group border rounded-2xl relative ml-7 max-md:hidden">
                        ...
                        <Link aria-label="See agrity plant growth promoters products" href="/products?=plant-growth-regulators" className='bg-[#FFF] rounded-full px-5 py-2 text-[#005B1B] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] bg-opacity-[90%] flex justify-center items-center opacity-0 group-hover:opacity-100 transition-all duration-500 ease-in-out'>
                            <span className="mr-2">Explore</span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 scale-90">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                            </svg>
            ...
            <Link aria-label="See agrity insecticides products" href="/products?=insecticides" className=' md:hidden'>
                <div className="overflow-hidden mt-[1.28rem] max-w-[22.8rem] max-h-[15rem] group border rounded-2xl relative">
                    <Image src={'/beetle.png'} alt="Picture of the author" width={400} height={500} className='w-full h-full object-cover group-hover:rotate-3 group-hover:scale-110 transition-all duration-500 ease-in-out' />
                    <h1 className="text-[#E3E3E3] text-[1.5rem] font-thin top-5 left-4 absolute">Insecticides</h1>
                    <div className='bg-[#FFF] rounded-full px-5 py-2 text-[#005B1B] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] bg-opacity-[90%] flex justify-center items-center transition-all duration-500 ease-in-out'>
                        <span className="mr-2">Explore</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 scale-90">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                        </svg>
            ...
            <Link aria-label="See agrity herbicides products" href="/products?=herbicides" className=' md:hidden'>
                <div className="overflow-hidden mt-[1.28rem] max-w-[22.8rem] max-h-[15rem] group border rounded-2xl relative">
            ...
            <Link aria-label="See agrity fungicides products" href="/products?=fungicides" className='md:hidden'>
                <div className="overflow-hidden mt-[1.28rem]  max-w-[22.8rem] max-h-[15rem] group border rounded-2xl relative">
            ...
            <Link aria-label="See agrity plant growth promoters products" href="/products?=plant-growth-regulators" className='md:hidden'>
                <div className="overflow-hidden mt-[1.28rem]  max-w-[22.8rem] max-h-[15rem] group border rounded-2xl relative">
