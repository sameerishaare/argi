  ...
  useEffect(() => {
    ...
    return (
        <div id="about-us" className='flex flex-col md:flex-row gap-4 m-4
         py-10 relative'>
          <svg className='absolute top-[-1.9rem] left-[-1.9rem]' xmlns="http://www.w3.org/2000/svg" width="228" height="271" viewBox="0 0 228 271" fill="none">
          ...
          <svg className='absolute bottom-[-1rem] right-[-1rem] z-[-1]' xmlns="http://www.w3.org/2000/svg" width="429" height="365" viewBox="0 0 429 365" fill="none">
